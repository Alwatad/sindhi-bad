...
// Seed data for initial Sindhi-bad setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Sindhi-bad store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Sindhi-bad. All rights reserved.',
  },
  settings: {
    siteName: 'Sindhi-bad',
